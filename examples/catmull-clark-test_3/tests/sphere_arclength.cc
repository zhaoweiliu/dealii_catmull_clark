...
void Nonlinear_shell<dim, spacedim>::arclength_system_rhs()
{
    ...
    double B = 2 * beta * beta * present_solution_alpha * (p_vector_rhs * p_vector_rhs);
    double C = radius * radius - present_solution_u * present_solution_u - beta * beta * (present_solution_alpha * present_solution_alpha) * (p_vector_rhs * p_vector_rhs);
...
void Nonlinear_shell<dim, spacedim>::solve()
{
    ...
    PVT.outer_product(p_vector_rhs, present_solution_u);
    ...
    double D = present_solution_u * newton_update_u;
