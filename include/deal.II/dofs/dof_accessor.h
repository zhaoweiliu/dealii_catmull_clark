...
public:
   ...
   */
  void
  set_non_local_dof_indices(const std::vector<types::global_dof_index> &non_local_dof_indices);
   ...
   */
  void
  rearrange_dof_indices(const std::vector<types::global_dof_index> dof_indices_new_order);
